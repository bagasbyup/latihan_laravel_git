...
Route::post('/simpan_input_produk', [InputProdukController::class, 'simpan_input_produk'])->name
('simpan_input_produk');
...
Route::post('/simpan_edit_produk/{id}', [InputProdukController::class, 'simpan_edit_produk'])->name
('simpan_edit_produk');
